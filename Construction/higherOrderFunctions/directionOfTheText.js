...
// function countBy(items, getScript) {
//     let counts = [];
//     for (let item of items) {
//         let script = getScript(item);
...
// function detectTheDirection(text) {
//     let scripts = countBy(text, char => {
//         let script = characterScript(char.codePointAt(0));
//         return script ? script : { name: "none" };
//     }).filter(object => object.name != "none");

//     let total = scripts.reduce((n, { count }) => n + count, 0);
//     if (total == 0) return "No scripts found";

//     let directionArray = [0, 0, 0]
//     for (script of scripts) {
//         if (script.direction == 'ltr') directionArray[0] += script.count;
//         if (script.direction == 'rtl') directionArray[1] += script.count;
//         if (script.direction == 'ttb') directionArray[2] += script.count;
//     }
//     if (directionArray[0] == Math.max(...directionArray)) return 'ltr'
//     if (directionArray[1] == Math.max(...directionArray)) return 'rtl'
//     if (directionArray[2] == Math.max(...directionArray)) return 'ttb'
// }
...
// console.log(detectTheDirection("Hello!"));

// console.log(detectTheDirection("Hey, مساء الخير"));
